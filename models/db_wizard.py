...
db.define_table('t_request_comments',
    ...
    Field('f_creations_date', type='date',
          label=T('Creation Date'),notnull=True,writable=False,readable=False),
    Field('f_created_by', type='references auth_user',
          label=T('Created By'),notnull=True,writable=False,readable=False),
    auth.signature,
    format='%(f_comments)s',
    migrate=settings.migrate)
...
db.define_table('t_apartment',
    Field('f_floor_id', type='references t_floor',
          label=T('Floor Number')),
...
db.define_table('t_room',
    Field('f_room_type_id', type='references t_floor',
          label=T('Room Type')),
    Field('f_apartment_id', type='references t_apartment',
          label=T('Apartment Id'),readable=False,writable=False),
    auth.signature,
